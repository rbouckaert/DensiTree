...
public class JFontChooser extends JComponent
{
	...
	private static Font DEFAULT_FONT = new Font("Dialog", Font.PLAIN, 10);
...
//	}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, locale("SelectFont"), true);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), locale("Sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(locale("SampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = locale("Plain");
			fontStyleNames[i++] = locale("Bold");
			fontStyleNames[i++] = locale("Italic");
			fontStyleNames[i++] = locale("BoldItalic");
		}
