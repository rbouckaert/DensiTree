...
public class CladePanel extends JPanel implements ChangeListener {
	...
	public CladePanel(DensiTree dt) {
		...
		textFieldSmallestClade.setText(m_dt.m_smallestCladeSupport + "");
		textFieldSmallestClade.setColumns(3);
		textFieldSmallestClade.addActionListener(e-> {
			try {
				m_dt.m_smallestCladeSupport = Double.parseDouble(textFieldSmallestClade.getText());
		...
		gbc_textFieldSmallestClade.fill = GridBagConstraints.HORIZONTAL;
		gbc_textFieldSmallestClade.gridx = 1;
		gbc_textFieldSmallestClade.gridy = 9;
		add(textFieldSmallestClade, gbc_textFieldSmallestClade);
	}
